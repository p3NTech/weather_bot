...
str random_message1 = lambda: random.choice(message1)
str random_message2 = lambda: random.choice(message2)
str random_message3 = lambda: random.choice(message3)
str random_message4 = lambda: random.choice(message4)
str random_message5 = lambda: random.choice(message5)
