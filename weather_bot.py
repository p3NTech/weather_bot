...
def test(message):
    ...
    try:
        ...
        bot.send_photo(message.chat.id, 'https://darkside.guru/files/404city.png', "Город " + city_name + " не найден " + constants.random_message3) # сообщение в случае если город не найден
