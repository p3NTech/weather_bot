...
def test(message):
    ...
    try:
        ...
        if weather["main"]['temp'] < -15:   #при -15
        ...
        elif weather["main"]['temp'] < 5:   #при 0
        ...
        elif weather["main"]['temp'] < 15:  #при +10
        ...
        elif weather["main"]['temp'] < 40:  #при +30
            status =  Предлагаю ознакомиться с топовыми моделями купальников в этом сезоне! Только сегодня вы можете стать обладательницей шикарного бикини!(реклама магазина купальников)" # random_message4 #
